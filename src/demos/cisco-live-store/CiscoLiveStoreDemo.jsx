          ...
          orders.map((order) => (
            <article key={order.id}>
              <div>
                ...
                <small>
                  {order.reservationCode} - {formatMoney(order.total)}
                </small>
    ...
    <>
      <section className="staff-hero">
        <div>
          ...
          <p>
            This is the employee-side system for inventory, reservations,
        ...
        <div className="staff-actions">
          ...
          <button className="icon-button danger" onClick={resetConsole} type="button">
            <RotateCcw size={16} />
            Reset
          </button>
        </div>
